...
def insert_account(username, password):
    try:
        ...
        cursor = conn.cursor()
        query = "INSERT INTO User (username, password,highest_score,music,volume,Cust1,Cust2,Cust3,Cust4,Curren_Cust,balance,e_volumn, control_mode) VALUES (%s,%s,0,0,0.5,1,0,0,0,0,0,0.5,0)"
